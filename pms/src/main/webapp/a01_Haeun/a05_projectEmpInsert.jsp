...
<head>
  ...
  <link href="../Dashio/css/table-responsive.css" rel="stylesheet">
  <link rel="stylesheet" href="./a01_css/projectEmpInsert.css">
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 인적자원 > 인적자원 관리 > 프로젝트 참여 사원 등록 </h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
			  ...
			  <input name="job" value="${param.job}"  id="input00" class="form-control mr-sm-2" placeholder="프로젝트명 입력" style="width:500px;"/><br>
		  	  <label class="col-lg-2 control-label">프로젝트번호</label>
			  <input name="ename" value="${param.ename}" id="input01" class="form-control mr-sm-2" placeholder="프로젝트번호 입력" style="width:300px;"/>
			  <label class="col-lg-2 control-label">참여인원수</label>
			  <input name="ename" value="${param.ename}" id="input01" class="form-control mr-sm-2" placeholder="참여인원수 입력" style="width:300px;"/>.
			  <label class="col-lg-2 control-label">계획 시작일</label>			 
			  <input type="date" id="input01" class="form-control mr-sm-2" placeholder="계획 시작일 입력" style="width:300px;"
				value='<fmt:formatDate value="${emp.hiredate}" pattern="yyyy-MM-dd"/>'/>
			  <label class="col-lg-2 control-label">계획 종료일</label>		  
			  <input type="date" id="input01" class="form-control mr-sm-2" placeholder="계획 종료일 입력" style="width:300px;"
				value='<fmt:formatDate value="${emp.hiredate}" pattern="yyyy-MM-dd"/>'/>
			  <label class="col-lg-2 control-label">참여 사원명 1.</label>
			  ...
			  <label class="col-lg-2 control-label">참여 사원명 2.</label>
			  <input name="ename" value="${param.ename}" id="input01" class="form-control mr-sm-2" placeholder="계획 시작일 입력" style="width:300px;"/>
			  <label class="col-lg-2 control-label">직책</label>
			  <input name="job" value="${param.job}"  id="input01" class="form-control mr-sm-2" placeholder="계획 종료일 입력" style="width:300px;"/><br>
			  <label class="col-lg-2 control-label">참여 사원명 3.</label>
			  <input name="ename" value="${param.ename}" id="input01" class="form-control mr-sm-2" placeholder="계획 시작일 입력" style="width:300px;"/>
			  <label class="col-lg-2 control-label">직책</label>
			  <input name="job" value="${param.job}"  id="input01" class="form-control mr-sm-2" placeholder="계획 종료일 입력" style="width:300px;"/><br>
			  <label class="col-lg-2 control-label">참여 사원명 4.</label>
			  <input name="ename" value="${param.ename}" id="input01" class="form-control mr-sm-2" placeholder="계획 시작일 입력" style="width:300px;"/>
			  <label class="col-lg-2 control-label">직책</label>
			  <input name="job" value="${param.job}"  id="input01" class="form-control mr-sm-2" placeholder="계획 종료일 입력" style="width:300px;"/><br>
			  <div class="buttonEmp">
			  <button class="btn btn-info" type="submit">등록</button>
			  <button class="btn btn-info" type="submit">초기화</button>
			  </div>
		 	  </nav>
			  </form>
