...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../Dashio/lib/bootstrap-fileupload/bootstrap-fileupload.css" />
  <link rel="stylesheet" type="text/css" href="../Dashio/lib/bootstrap-datepicker/css/datepicker.css" />
  <link rel="stylesheet" type="text/css" href="../Dashio/lib/bootstrap-daterangepicker/daterangepicker.css" />
  <link rel="stylesheet" type="text/css" href="../Dashio/lib/bootstrap-timepicker/compiled/timepicker.css" />
  ...
  <link rel="stylesheet" href="./a01_css/empInsert.css">
...
<body>
  <section id="container">
    ...
    <section id="main-content">
      ...
      <h3><i class="fa fa-angle-right"></i>인적자원 > 인적자원 관리 > 사원 상세정보 </h3>
      <!--ADVANCED FILE INPUT-->
                      ...
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <div class="form-group last">		                  
		                  ...
		                  <div class="form-group">
		                    ...
		                    <div class="fileupload fileupload-new" data-provides="fileupload">
		                      <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
		                        <img src="https://scontent-gmp1-1.xx.fbcdn.net/v/t1.6435-9/117372438_2740328656256203_9116013527610482626_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=9267fe&_nc_ohc=ypwsYpdQ8_YAX8x9KzZ&_nc_ht=scontent-gmp1-1.xx&oh=00_AT-DZGEXkLMDWBHyX5RNBFQJtMFbq7LBPNYPoELLaoHgrw&oe=6311C127" alt="" />
		                      </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" placeholder="신짱구" id="c-name" class="form-control" value="김짱구">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">사원번호*</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="c-name" class="form-control" value="1234">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">부서명</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="lives-in" class="form-control" value="1234">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">부서번호</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="country" class="form-control" value="1234">
                            </div>
                          </div>
                          <div class="form-group">
